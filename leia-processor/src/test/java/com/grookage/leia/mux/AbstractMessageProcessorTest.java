...
class AbstractMessageProcessorTest {
    ...
    void testHttpMessageProcessor() {
        ...
        final var messageProcessor = new AbstractMessageProcessor("test", 10_000L, resolver, executorFactory) {
            @Override
        ...
        final var messageProcessor1 = new AbstractMessageProcessor("test", 10_000L, resolver, executorFactory) {
            @Override
            protected boolean validBackends(List<String> backends) {
                return true;
            }
